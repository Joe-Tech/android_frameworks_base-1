...
/**
 * PmHistogramFilter takes in an image in HSVA format and computes a 2-D histogram with a
 * 2 dimensional pm histogram based on hue (column) and saturation (row) at the top and
 * a 1-D value histogram in the last row. The number of bin in the value histogram equals to
 * the number of bins in hue.
 */
public final class NewPmHistogramFilter extends Filter {
    ...
    public NewPmHistogramFilter(MffContext context, String name) {
        super(context, name);
    }
    ...
    protected void onProcess() {
        ...
        // Run native method
        extractPmHistogram(imageBuffer, floatHistogram, mHueBins, mSaturationBins, mValueBins,
    ...
    private static native void extractPmHistogram(ByteBuffer imageBuffer,
